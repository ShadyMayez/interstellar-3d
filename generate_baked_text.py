...
OUTPUT_PATH = '/home/shady/Downloads/interstellar/active-theory-local-viewer/public/assets/geometry/interstellar_text.glb'

print("=" * 60)
print("Generating 3D Text GLB with +90 deg X rotation for upright view")
print("=" * 60)
...
# Rotate X by +90 deg in Blender to make text right-side up in Three.js
...
print("Exported upright GLB to:", OUTPUT_PATH)
